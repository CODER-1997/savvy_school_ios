...
import 'package:savvy_school_ios/screens/admin/students/student_types/group_filter_screen.dart';
import 'package:savvy_school_ios/screens/admin/students/student_types/students_filter_screen.dart';
...
class FilterScreenWrapper extends StatefulWidget {
  final List students;
  ...
  @override
  State<FilterScreenWrapper> createState() => _FilterScreenWrapperState();
}

class _FilterScreenWrapperState extends State<FilterScreenWrapper>
    ...
    return Scaffold(
        ...
        body: Padding(
          ...
          child: TabBarView(
            controller: _tabController,
            children: [
             GroupFilterScreen(students: widget.students, groups: widget.groups, paidStudents: widget.paidStudents),
             StudentFilterScreen(students: widget.students, groups: widget.groups, paidStudents: widget.paidStudents)
